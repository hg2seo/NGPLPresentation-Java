...
public enum Status {
    ...
    BAD_REQUEST_ARGUMENT(400, "필드의 값이 기초 유효성 검사를 통과하지 못했습니다.", HttpStatus.BAD_REQUEST),
    BAD_REQUEST_ARGUMENT_PWD_MIN_MAX(400, "비밀번호는 8자 이상, 16자 이하의 문자열이어야 합니다.", HttpStatus.BAD_REQUEST),
    BAD_REQUEST_ARGUMENT_PWD_NOT_SAME(400, "비밀번호가 일치하지 않습니다.", HttpStatus.BAD_REQUEST),
